...
class TestParseVersion():
    ...
    def test_lt(self):
        ...
        example_lists = ['v1.0 v1.0.1 v1.0.2 v1.0.3 v1.1.0-rc1 v1.1.0-rc2 v1.1.0 v1.1.1 '
                         'v1.1.2 v1.1.3 v2.0.0-rc v2.0.0-rc2 v2.0.0-rc3 v2.0.0-preview '
                         'v2.0.0 v2.1.0 v2.2.0 v2.2.1'.split(), 'v0.13.0 v0.13.1 v0.13.2 v0.14.0-alpha '
                                                                'v0.14.0-beta v0.14.0-rc.1 v0.14.0-rc.2'.split(),
                         '1.0.0-alpha 1.0.0-alpha.1 1.0.0-alpha.beta 1.0.0-beta '
                         '1.0.0-beta.2 1.0.0-beta.11 1.0.0-rc.1 1.0.0'.split(), '0.1 0.2 0.3 1.0 1.1'.split(),
                         '1.1.0 1.1.1 1.1.2 1.2.0'.split(), '0.9 1.0a1 1.0a2 1.0b1 1.0rc1 1.0 1.1a1'.split(),
